...
function filterTreeData(nodes, filterFn, childrenField) {
  ...
  return nodes.map(function (node) {
    ...
    if (filterFn(node)) {
      return tslib.__assign(tslib.__assign({}, node), (_a = {}, _a[childrenField] = children, _a));
    }
    // If any child matches, keep this node with all its children (not just filtered)
    if (filteredChildren.length > 0) {
      return tslib.__assign(tslib.__assign({}, node), (_b = {}, _b[childrenField] = children, _b));
    }
...
var DataGrid = /*#__PURE__*/React.forwardRef(function (_a, ref) {
  ...
  var renderRow = function (virtualRow) {
    ...
    if (item.type === "data") {
      ...
      , {
      ...
      }), addRowConfig && masterDetail && Array.isArray(row_2 === null || row_2 === void 0 ? void 0 : row_2.children) && row_2.children.length < 1 && (/*#__PURE__*/React.createElement(TableCell, {
        ...
        onClick: function () {
          ...
          if (typeof onDataChange === "function") {
            var updatedRow = tslib.__assign(tslib.__assign({}, row_2), {
              children: tslib.__spreadArray(tslib.__spreadArray([], Array.isArray(row_2.children) ? row_2.children : [], true), [emptyChild], false)
            });
          ...
          if (typeof rowIndex_1 !== "undefined") {
            setExpandedRows(function (prev) {
              var _a;
              return tslib.__assign(tslib.__assign({}, prev), (_a = {}, _a[rowIndex_1] = true, _a));
            });
          }
        }
