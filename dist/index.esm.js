...
import { CheckIcon, ChevronDownIcon, ChevronUpIcon, Calendar, XCircle, ChevronLeftIcon, ChevronRightIcon, Clock, CalendarIcon, CircleCheck, CircleAlert, X, Search, ChevronFirst, ChevronLeft, ChevronRight, ChevronLast, GripHorizontal, Sigma, List, ChevronUp, ChevronDown, ChevronsUpDown, ListFilter, Plus, SquareX } from 'lucide-react';
...
function SimpleTimePicker(_a) {
  ...
  return /*#__PURE__*/React__default.createElement(Popover, {
    ...
    className: "mr-2 size-4"
  }), display, /*#__PURE__*/React__default.createElement(ChevronDownIcon, {
    className: "ml-2 size-4 shrink-0 opacity-50"
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      ref: v.value === hour ? hourRef : undefined,
      key: v.value
    }, /*#__PURE__*/React__default.createElement(TimeItem, {
      option: v,
      selected: v.value === hour,
      onSelect: onHourChange,
      disabled: v.disabled,
  ...
  }))), use12HourFormat && (/*#__PURE__*/React__default.createElement(ScrollArea, {
    className: "h-full flex-grow"
  }, /*#__PURE__*/React__default.createElement("div", {
    className: "flex grow flex-col items-stretch overflow-y-auto pe-2"
  }, ampmOptions.map(function (v) {
    return /*#__PURE__*/React__default.createElement(TimeItem, {
      key: v.value,
      option: v,
      selected: v.value === ampm,
      onSelect: onAmpmChange,
...
function Tooltip(props) {
  return /*#__PURE__*/React.createElement(TooltipProvider, null, /*#__PURE__*/React.createElement(TooltipPrimitive.Root, __assign({
    "data-slot": "tooltip"
  }, props)));
}
function TooltipTrigger(props) {
  return /*#__PURE__*/React.createElement(TooltipPrimitive.Trigger, __assign({
...
var GroupPanel = function (_a) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("div", {
    ...
    }, /*#__PURE__*/React__default.createElement(GripHorizontal, {
...
var ColumnSidebar = function (_a) {
  ...
  var aggColumns = useMemo(function () {
  ...
  return /*#__PURE__*/React__default.createElement("aside", {
  ...
  }, pivotMode && (/*#__PURE__*/React__default.createElement("div", {
  ...
  }, "Pivot Mode"))), /*#__PURE__*/React__default.createElement("div", {
    className: "w-full",
    style: {
      display: "flex",
      flexDirection: "column",
      ...
      onCheckedChange: function (checked) {
        setColumns(function (cols) {
          return cols.map(function (c) {
            return c.field === col.field ? __assign(__assign({}, c), {
              visible: checked
            }) : c;
          });
        });
  ...
  })), enablePivot && (/*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("div", {
    className: "mt-4",
    style: {
      // marginBottom: "0.5rem",
      display: "flex",
  ...
  }, /*#__PURE__*/React__default.createElement(Sigma, {
    style: {
      width: "1rem"
    }
  }), /*#__PURE__*/React__default.createElement("span", {
  ...
  }, aggColumns && aggColumns.length > 0 ? (/*#__PURE__*/React__default.createElement("div", {
    className: "flex flex-col gap-2"
    ...
    return /*#__PURE__*/React__default.createElement("div", {
    ...
    }, col.headerName || col.field), /*#__PURE__*/React__default.createElement("div", {
      ...
      onChange: function (e) {
        setColumnAggFnMap === null || setColumnAggFnMap === void 0 ? void 0 : setColumnAggFnMap(function (prev) {
          var _a;
          return __assign(__assign({}, prev), (_a = {}, _a[col.field] = e.target.value, _a));
        });
      },
      style: {
    ...
    className: "text-gray-400 text-sm"
  }, "Drag columns here for aggregation"))))))), !columnAggFnMap && !setColumnAggFnMap && (/*#__PURE__*/React__default.createElement("div", {
    style: {
      padding: "0.75rem 1rem",
      borderBottom: "1px solid #353945"
    }
...
var PivotPanel = function (_a) {
  ...
  }, pivotColumns.length > 0 && (/*#__PURE__*/React__default.createElement("div", {
...
function pivotAndAggregateByGroup(data, groupBy, pivotColumns, columnDefs) {
  var allowedNumericFields = new Set(__spreadArray(["year"], columnDefs.map(function (def) {
    return def.field;
  }), true));
  ...
  function generateCombinations(keys, prefix) {
    ...
    var first = keys[0],
      rest = keys.slice(1);
    for (var _i = 0, _b = Array.from(pivotValuesMap[first]); _i < _b.length; _i++) {
      var val = _b[_i];
      generateCombinations(rest, __assign(__assign({}, prefix), (_a = {}, _a[first] = val, _a)));
    }
  }
  ...
  cleanedData.forEach(function (row) {
    ...
    if (!groupEntry.childrenMap.has(pivotKey)) {
      var newRow_1 = __assign((_a = {}, _a[groupBy] = groupValue, _a), Object.fromEntries(pivotColumns.map(function (key) {
        return [key, row[key]];
      })));
      var childSum_1 = 0;
      columnDefs.forEach(function (col) {
  ...
  for (var _i = 0, groupByValues_1 = groupByValues; _i < groupByValues_1.length; _i++) {
    ...
    var _loop_1 = function (combo) {
      ...
      if (!groupEntry.childrenMap.has(pivotKey)) {
        var newRow_2 = __assign((_g = {}, _g[groupBy] = groupValue, _g), combo);
        columnDefs.forEach(function (col) {
  ...
  for (var _b = 0, _c = Array.from(groupMap.entries()); _b < _c.length; _b++) {
    var _d = _c[_b],
      groupKey = _d[0],
      _e = _d[1],
...
function buildTreeData(flatData, treeDataChildrenField, getDataPath // optional for parentId/children formats
    ...
    flatData.forEach(function (row) {
      ...
      path.forEach(function (segment, idx) {
        ...
        if (!pathMap_1.has(currentPath)) {
          var node = idx === path.length - 1 ? __assign(__assign({}, row), {
            children: []
          }) : {
            name: segment,
  ...
  if (treeDataChildrenField === "parentId") {
    ...
    flatData.forEach(function (row) {
      ...
      idMap_1.set(id, __assign(__assign({}, row), {
        children: []
      }));
    });
    flatData.forEach(function (row) {
...
function flattenTree(nodes, expanded, level, rowIndexRef, parentPath) {
  ...
  nodes.forEach(function (node) {
    ...
    var nodePath = __spreadArray(__spreadArray([], parentPath, true), [nodeName], false);
...
function moveTreeNode(tree, sourcePath, targetPath) {
  ...
  nodeToMove.path = __spreadArray(__spreadArray([], targetPath, true), [nodeToMove.name], false);
 ...
 */
function filterTreeData(nodes, filterFn, childrenField) {
  ...
  return nodes.map(function (node) {
    ...
    if (filterFn(node)) {
      return __assign(__assign({}, node), (_a = {}, _a[childrenField] = children, _a));
    }
    // If any child matches, keep this node with all its children (not just filtered)
    if (filteredChildren.length > 0) {
      return __assign(__assign({}, node), (_b = {}, _b[childrenField] = children, _b));
    }
...
var DataGrid = /*#__PURE__*/forwardRef(function (_a, ref) {
  ...
  var _t = useState(pivotMode),
    enablePivot = _t[0],
    setEnablePivot = _t[1];
  var defaultPivotColumns = useMemo(function () {
    var _a;
  ...
  var _u = useState(defaultPivotColumns),
    pivotColumns = _u[0],
    setPivotColumns = _u[1];
  var _v = useState(columnDefs);
    _v[0];
    _v[1];
  ...
  var _y = useState(serverAggCols ? serverAggCols : aggCols || []),
    _aggCols = _y[0],
    _setAggCols = _y[1];
  // 🧠 Automatically filter when columnDefs or _aggCols change
  var selectedAggFn = useState("sum")[0];
  ...
  var handleAggDrop = function (e) {
    ...
    setColumnAggFnMap(function (prev) {
      var _a;
      return __assign(__assign({}, prev), (_a = {}, _a[field] = selectedAggFn || "sum", _a));
    });
  };
  var groupByField = useMemo(function () {
    var _a, _b;
  ...
  var groupedPivotedData = useMemo(function () {
    var _a;
    ...
    if (groupByField && _aggCols) {
      ...
      if (sortDirection && grouped.length > 0) {
        return __spreadArray([], grouped, true).sort(function (a, b) {
          var _a, _b, _c, _d;
  ...
  var pivotDataColumns = useMemo(function () {
  ...
  var togglePivot = useCallback(function () {
      ...
      while (parentKey !== null) {
        ...
        if (parent_1 && parent_1.row && parent_1.row.children) {
          var allChildrenKeys = parent_1.row.children.map(function (child) {
            return __spreadArray(__spreadArray([], parentKey.split("/"), true), [child.name], false).join("/");
          });
  ...
  var handlePivotDrop = useCallback(function (e) {
    e.preventDefault();
    if (!enablePivot) return;
  ...
  var toggleTreeRowExpand = useCallback(function (nodeKey) {
    setTreeExpandedRows(function (prev) {
      var _a;
      return __assign(__assign({}, prev), (_a = {}, _a[nodeKey] = !prev[nodeKey], _a));
    });
  }, []);
  ...
  useEffect(function () {
    if (treeData && gridData && Array.isArray(gridData) && !treeInit) {
      ...
      var getNodeKey_1 = function (node, parentPath) {
        ...
        var nodeName = typeof node.name === "string" ? node.name : String((_a = node.name) !== null && _a !== void 0 ? _a : "");
        return __spreadArray(__spreadArray([], parentPath, true), [nodeName], false).join("/");
      };
      var expandAll_1 = function (nodes, parentPath) {
        ...
        nodes.forEach(function (node) {
          ...
          if (node.children && node.children.length > 0) {
            ...
            expandAll_1(node.children, __spreadArray(__spreadArray([], parentPath, true), [nodeName], false));
          }
        });
      };
      var expandLevels_1 = function (nodes, levels, parentPath) {
        ...
        nodes.forEach(function (node) {
          ...
          if (node.children && node.children.length > 0) {
            initialExpanded_1[nodeKey] = true;
            expandLevels_1(node.children, levels - 1, __spreadArray(__spreadArray([], parentPath, true), [nodeName], false));
          }
        });
      };
  ...
  var filteredData = useMemo(function () {
    if (treeData) {
      return filterTreeData(gridData, function (row) {
    ...
    return filtered;
  }, [gridData, debouncedFilters, filterTypes, columns, treeData, treeDataChildrenField, isServerSide]);
  // ----------------------------
  // 2) Sorting
  // ----------------------------
  ...
  var flattenedRows = useMemo(function () {
    ...
    if (treeData && filteredData && Array.isArray(filteredData)) {
      ...
      return flattenTree(filteredData, treeExpandedRows, 0, {
        current: 0
      });
    }
  ...
  var handleTreeRowDrop = useCallback(function (draggedNodeKey, targetNodeKey) {
  ...
  var handleTreeRowsDrop = useCallback(function (draggedNodeKeys, targetNodeKey) {
    var _a, _b, _c;
    if (!rowDragManaged || !treeData) return;
  ...
  var renderRow = function (virtualRow) {
    ...
    if (item.type === "group") {
      ...
      return /*#__PURE__*/React__default.createElement(TableRow, {
        ...
        }, "(", item.itemCount, " items)")))) : "aggFunc" in col && col.aggFunc && item.aggregations && item.aggregations[col.field] !== undefined ? (/*#__PURE__*/React__default.createElement("div", {
          className: "w-full"
        }, /*#__PURE__*/React__default.createElement("div", {
    ...
    if (item.type === "data") {
      ...
      if (treeData && hasChildren && item.type === "data") {
        ...
        }, treeExpandedRows[nodeKey_1] ? (/*#__PURE__*/React__default.createElement(ChevronDown, {
          className: "size-4 "
        })) : (/*#__PURE__*/React__default.createElement(ChevronRight, {
          className: "size-4"
        })));
      ...
      , {
        ...
        if (isFullRowEditing_1 && col.editable) {
          return /*#__PURE__*/React__default.createElement(TableCell, {
            key: col.field
          }, /*#__PURE__*/React__default.createElement(CellEditor, {
            ...
            columnDef: __assign(__assign({}, col), {
              editorType: col.editorType || "text"
            }),
            onKeyDown: function (e) {
              if (e.key === "Enter") {
                var updatedRow = __assign(__assign({}, row_2), editingRowData);
            ...
            onChange: function (value) {
              ...
              setEditingRowData(function (prev) {
                var _a;
                return __assign(__assign({}, prev), (_a = {}, _a[col.field] = value, _a));
              });
              onCellValueChanged({
                value: value,
                field: col.field,
                data: __assign(__assign(__assign({}, row_2), editingRowData), (_a = {}, _a[col.field] = value, _a))
              });
            }
          }));
        }
        ...
        if (colIndex === 0 && treeData) {
          return /*#__PURE__*/React__default.createElement(TableCell, {
          ...
          }, expandButton_1, rowDragManaged && treeData && (/*#__PURE__*/React__default.createElement("span", {
            draggable: true,
            onDragStart: function (e) {
              e.stopPropagation();
              e.dataTransfer.effectAllowed = "move";
            ...
            className: "size-4"
          }))), /*#__PURE__*/React__default.createElement("span", null, formatCellValue(cellValue, row_2 || {}, col), showChildCount && Array.isArray(row_2 === null || row_2 === void 0 ? void 0 : row_2.children) && row_2.children.length > 0 && (/*#__PURE__*/React__default.createElement("span", {
        ...
        if ("rowGroup" in col && col.rowGroup && enablePivot && pivotColumns.length > 0) {
          ...
          }, /*#__PURE__*/React__default.createElement("div", null, String(row_2 === null || row_2 === void 0 ? void 0 : row_2[col.field]), " (", totalMedals, ")"));
        }
        return /*#__PURE__*/React__default.createElement(TableCell, {
          key: col.field,
          style: __assign(__assign({}, getCellWidth(col)), {
          ...
          data: row_2,
          rowIndex: rowIndex_1
        })) : isEditing && editorType !== "checkbox" ? (/*#__PURE__*/React__default.createElement(CellEditor, {
          value: editValue,
          columnDef: {
        ...
        })) : editorType === "checkbox" && col.editable ? (/*#__PURE__*/React__default.createElement("div", {
        ...
        // col.tooltipField
        "tooltipField" in col && col.tooltipField ? (/*#__PURE__*/React__default.createElement(Tooltip, null, /*#__PURE__*/React__default.createElement(TooltipTrigger, {
          asChild: true
      ...
      }), addRowConfig && masterDetail && Array.isArray(row_2 === null || row_2 === void 0 ? void 0 : row_2.children) && row_2.children.length < 1 && (/*#__PURE__*/React__default.createElement(TableCell, {
        ...
        onClick: function () {
          var _a;
          var detailCols = ((_a = columnDefs.detailGridOptions) === null || _a === void 0 ? void 0 : _a.columns) || [];
          var emptyChild = {};
          detailCols.forEach(function (col) {
            emptyChild[col.field] = "";
          });
          if (typeof onDataChange === "function") {
            var updatedRow = __assign(__assign({}, row_2), {
              children: __spreadArray(__spreadArray([], Array.isArray(row_2.children) ? row_2.children : [], true), [emptyChild], false)
            });
            onDataChange(updatedRow, row_2, "children");
          }
          if (typeof rowIndex_1 !== "undefined") {
            setExpandedRows(function (prev) {
              var _a;
              return __assign(__assign({}, prev), (_a = {}, _a[rowIndex_1] = true, _a));
            });
          }
        }
  ...
  var handleStopEditing = useCallback(function () {
    setEditingRowId(null);
  ...
  return /*#__PURE__*/React__default.createElement("div", {
  ...
  }, loadingMessage)))), enablePivot && setPivotColumns && (/*#__PURE__*/React__default.createElement(PivotPanel, {
  ...
  })), gridData.length > 0 && grandTotalRow === "top" && renderTotalRow(), /*#__PURE__*/React__default.createElement("div", {
  ...
  }, /*#__PURE__*/React__default.createElement(React__default.Fragment, null, enablePivot && pivotDataColumns && pivotDataColumns.length !== 0 && (/*#__PURE__*/React__default.createElement("thead", {
    ...
    var combinations = pivotValues.reduce(function (acc, values) {
      return acc.flatMap(function (comb) {
        return values.map(function (val) {
          return __spreadArray(__spreadArray([], comb, true), [val], false);
        });
      });
    }, [[]]);
    ...
    return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, pivotFields.map(function (pivotField, rowIndex) {
      ...
      for (var i = 0; i < combinations.length * metrics.length; i += repeatFactor) {
        ...
        if (value !== lastValue) {
          headerCells.push(/*#__PURE__*/React__default.createElement("th", {
      ...
      }, rowIndex === 0 && groupedColumns.length !== 0 && (/*#__PURE__*/React__default.createElement("th", {
    ...
    }), /*#__PURE__*/React__default.createElement("tr", null, combinations.map(function (_, index) {
  ...
  }())), groupedPivotedData && groupedPivotedData.length > 0 && enablePivot && pivotColumns.length > 0 && !(serverPivoting && serverPivotCols && serverPivotCols.length < 1) && (/*#__PURE__*/React__default.createElement(TableBody, null, groupedPivotedData.map(function (group) {
    var _a, _b;
    return /*#__PURE__*/React__default.createElement(TableRow, {
      key: "".concat(group.groupKey, "-").concat(sortDirection),
      className: "table-row-pop"
    }, groupedColumns.length !== 0 && (/*#__PURE__*/React__default.createElement("th", {
      className: "text-center border border-gray-200 px-4 py-2 font-normal text-sm text-gray-700"
    ...
    }, /*#__PURE__*/React__default.createElement("p", null, col.headerName))),
    // col.headerTooltip &&
    "headerTooltip" in col && col.headerTooltip && (/*#__PURE__*/React__default.createElement(TooltipContent, {
      className: ""
    ...
    "showFilter" in col && col.showFilter !== false && (/*#__PURE__*/React__default.createElement("div", {
  ...
  }), addRowConfig && (/*#__PURE__*/React__default.createElement(TableHead, {
    className: "w-[50px]",
    style: {
      paddingLeft: "12px",
      paddingTop: "6px"
    ...
    className: ""
  }, "+ Add Row")))))), /*#__PURE__*/React__default.createElement(TableBody, null, newRowData && isAddingRow && (/*#__PURE__*/React__default.createElement(TableRow, {
    ...
    return /*#__PURE__*/React__default.createElement(TableCell, {
      ...
      onChange: function (val) {
        return setNewRowData(function (prev) {
          var _a;
          return __assign(__assign({}, prev), (_a = {}, _a[col.field] = val, _a));
        });
      },
      onKeyDown: function (e) {
        var _a;
  ...
  }), addRowConfig && (/*#__PURE__*/React__default.createElement(TableCell, {
  ...
  }, /*#__PURE__*/React__default.createElement(SquareX, {
    strokeWidth: 1.5
  }))))))), (!enablePivot || !serverPivoting && pivotColumns.length < 1 || serverPivoting && !(serverPivotCols === null || serverPivotCols === void 0 ? void 0 : serverPivotCols.length)) && (/*#__PURE__*/React__default.createElement(TableBody, {
    style: {
